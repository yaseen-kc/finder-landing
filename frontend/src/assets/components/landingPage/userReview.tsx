import { USER_REVIEWS, USER_REVIEW_STRINGS, type UserReview as Review } from "../../constants/landingPage/userReviewConstants";
  ...
  return (
    <section className="mx-auto max-w-screen-2xl px-4 py-10">
      <div className="w-full rounded-3xl bg-zinc-200/60 text-zinc-800 px-6 sm:px-10 py-8 sm:py-10 shadow-inner">
        <div className="text-3xl leading-none select-none">{USER_REVIEW_STRINGS.QUOTE_MARK}</div>
        ...
        <div className="mt-6 sm:mt-8 text-base sm:text-lg font-semibold text-zinc-900">{USER_REVIEW_STRINGS.AUTHOR_PREFIX}{review.author}</div>
      </div>
    </section>
  );
}
